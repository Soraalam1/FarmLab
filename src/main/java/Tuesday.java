...
public class Tuesday {
    public static void main(String[] args) {
        ...
        CornStalk cornStalk6 = new CornStalk(true, false);
        CornStalk cornStalk7 = new CornStalk(true, false);
        CornStalk cornStalk8 = new CornStalk(true, false);
        CornStalk cornStalk9 = new CornStalk(true, false);
        CornStalk cornStalk10 = new CornStalk(true, false);
        CornStalk cornStalk11 = new CornStalk(true, false);
        CornStalk cornStalk12 = new CornStalk(true, false);
        CornStalk cornStalk13 = new CornStalk(true, false);
        CornStalk cornStalk14 = new CornStalk(true, false);
        CornStalk cornStalk15 = new CornStalk(true, false);
        ...
        TomatoPlant tomato1 = new TomatoPlant(false, true);
        TomatoPlant tomato2 = new TomatoPlant(false, true);
        TomatoPlant tomato3 = new TomatoPlant(false, true);
        TomatoPlant tomato4 = new TomatoPlant(false, true);
        TomatoPlant tomato5 = new TomatoPlant(false, true);
        TomatoPlant tomato6 = new TomatoPlant(false, true);
        TomatoPlant tomato7 = new TomatoPlant(false, true);
        TomatoPlant tomato8 = new TomatoPlant(false, true);
        TomatoPlant tomato9 = new TomatoPlant(false, true);
        TomatoPlant tomato10 = new TomatoPlant(false, true);
        TomatoPlant tomato11 = new TomatoPlant(false, true);
        TomatoPlant tomato12 = new TomatoPlant(false, true);
        ...
        System.out.println();
        System.out.println("Every Tuesday Froilan harvests crops...");
        Froilan.mount(mcFroilanTractor);
        for (CropRow currentCropRow:farm.getField().getCropRows()) {
            mcFroilanTractor.harvestCropRow(currentCropRow);
        }
        Froilan.dismount(mcFroilanTractor);
        System.out.println();
        System.out.println("Froilan has harvested all the crops! The day is over!");
    }
}
